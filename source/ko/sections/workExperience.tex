...
\begin{cvitems}
\item {개발팀 리드를 맡았습니다.}
\item {e-커머스 기업이 더 나은 구매 여정을 만들 수 있도록 도와주는 SaaS 도구인 ADCIO 제품을 개발했습니다.}
\item {- 주요 기능은 리테일 미디어 솔루션, 개인화 추천 시스템 및 LLM 에이전트입니다.}
\item {아키텍쳐 설계 및 구현, DevOps 제반 업무, 테크 스펙 및 코드 리뷰 등을 담당했습니다.}
\item {팀원 관리, 개발 프로세스 개선 등을 담당했습니다.}
\end{cvitems}
