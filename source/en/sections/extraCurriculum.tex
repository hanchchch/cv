...
\item {Developed and managed the platform for the event.}
\end{cvitems}
...
\item {Held a CTF as a member of the team CyKor. More than a hundred competitors participated.}
...
\item {Found several vulnerabilities and exploits including Stored XSS, Information disclosure, open redirect, etc at one of largest Korean software companies' web services.}
\end{cvitems}
