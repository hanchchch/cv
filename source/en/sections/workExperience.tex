...
\item {Building the product ADCIO, a SaaS tool for helping e-commerce companies make better buyer's journey}
\item {- Key features are a retail-media solution, a personalized recommendation system and a LLM agent}
\item {Designed and implemented architecture, DevOps related works, tech spec and code review.}
\item {Managed team members, improved organizational structure and developing processes.}
\end{cvitems}
