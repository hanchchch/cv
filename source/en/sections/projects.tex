...
\item {Used Solidity, Hardhat, NestJS, and Next.js.}
\item {Deployed contracts on the Polygon test network and servers on AWS ECS.}
\end{cvitems}
...
\item {Built a simple FaaS platform, to operate heterogenous functions in cloud environment}
...
\item {DI pattern is used to make the settings such as RTS, frame rate, and detect range configurable.}
